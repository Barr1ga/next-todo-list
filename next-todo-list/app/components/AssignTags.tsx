    ...
    <Menu as="div" className="relative inline-block text-left">
      <div>
        <div className="flex gap-2">
          {!assignTags && <Menu.Button onClick={(e) => { e.stopPropagation(); }} className="h-[30px] flex justify-center items-center gap-2 rounded-md border border-gray/20 bg-white px-2 font-medium hover:bg-gray/10 ease-out duration-200">
            <p className="text-xs">
            </p>
            <HiChevronDown></HiChevronDown>
          </Menu.Button>}

          {assignTags && <Menu.Button onClick={(e) => { e.stopPropagation(); }} className="flex items-center justify-center border border-gray/10 hover:bg-gray/10 rounded h-[22px] w-[22px]  ease-out duration-200">
