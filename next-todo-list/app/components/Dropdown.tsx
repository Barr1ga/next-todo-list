...
export default function Dropdown({ stateValue, stateSetter, options }: { stateValue: string, stateSetter(param: string): void, options: string[] }) {
  return (
    <Menu as="div" className="relative inline-block text-left">
      ...
      >
        <Menu.Items className="bg-background border py-1 border-gray/20 absolute right-0 z-10 mt-1 w-56 origin-top-right rounded-md bg-white shadow-xl shadow-[#000]/30  ring-opacity-5 focus:outline-none">
